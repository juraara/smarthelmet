    ...
    if( extendedCodeLevel == 0 ) {  
        ...
        switch( code ) {
            ...
            case ( 0x83 ):
                ...
                dataArray[3] = (double) delta;
                dataArray[4] = (double) theta;
                dataArray[5] = (double) lowalpha;
                dataArray[6] = (double) highalpha;
                dataArray[7] = (double) lowbeta;
                dataArray[8] = (double) highbeta;
                dataArray[9] = (double) lowgamma;
                dataArray[10] = (double) midgamma;
